...
const Services: VFC<ServicesProps> = () => {
        return (
            <div className='block px-4 py-20 text-center min-h-75vh bg-gradient-to-b from-navy-300 via-navy-200 to-navy-500 lg:h-screen'>
                        ...
                        {services.map(service => {
                            ...
                            return (
                                <article>
                                    ...
                                    <section 
                                        className='z-2 relative px-6 py-12 mt-8 space-y-3 duration-500 transform bg-gray-100 border-0.2 border-white rounded-lg backdrop-blur-10 bg-opacity-10 bg-clip-padding lg:py-24  hover:-translate-y-5' 
                                        key={id}
                                    >
