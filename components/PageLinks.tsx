        ...
        <>
            {
                        ...
                        <ul className='items-center hidden md:flex'>
                            {
                                linkData.map(link => (
                                    <li key={link.id} className='p-2 mx-4 md:mx-2'>
                                        <Link href={link.url}>
                                        <a className='text-2xl font-bold tracking-widest text-gray-600 transition transform md:text-2xl hover:text-navy-600'>{link.text}</a>
                                        </Link>
                                    </li>
                                ))
                            }
                ...
                : (
                    <div className="fixed top-0 left-0 z-20 w-full h-full bg-gray-100 backdrop-blur-10 bg-opacity-10 bg-clip-padding md:hidden">
                        <button
                            type='button'
                        ...
                        <div className="flex flex-col items-center pt-60 space-y-9 ">
                            {
                                linkData.map(link => (
